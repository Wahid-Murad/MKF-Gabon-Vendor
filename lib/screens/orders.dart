                    ...
                    children: [
                      ...
                      Text(
                          ...
                          style: TextStyle(
                              ...
                              fontWeight: FontWeight.w400)),
                      Text(
    _orderList[index].paymentStatus == "paid"?"Payé":"Non payé",
                          style: TextStyle(
                  ...
                  children: [
                    ...
                    Text(
                        ...
                        style: TextStyle(
                            ...
                            fontSize: 12,
                            fontWeight: FontWeight.w400)),
                    Text(_orderList[index].deliveryStatus=="pending"?'en cours':
                    _orderList[index].deliveryStatus=="confirmed"?'confirmé':
                    _orderList[index].deliveryStatus=="picked_up"?'recupéré':
                    _orderList[index].deliveryStatus=="on_the_way"?'en route':
                    _orderList[index].deliveryStatus=="delivered"?'livré': 'annulé',
                        style: TextStyle(
                            color: MyTheme.font_grey,
                            fontSize: 12,
                            fontWeight: FontWeight.w400)),
