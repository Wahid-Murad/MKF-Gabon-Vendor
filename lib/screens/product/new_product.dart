...
class _NewProductState extends State<NewProduct> {
  ...
  setConstDropdownValues() {
    ...
    shippingConfigurationList.addAll([
      CustomRadioModel("Livraison gratuite", "free", true),
      CustomRadioModel("Forfait", "flat_rate", false),
    ]);
    stockVisibilityStateList.addAll([
      CustomRadioModel("Afficher la quantité en stock", "quantity", true),
      CustomRadioModel("Afficher le stock avec du texte uniquement", "text", false),
      CustomRadioModel("Masquer les stocks", "hide", false)
    ]);
  ...
  getTaxType() async {
    ...
    taxRes.data!.forEach((element) {
      vatTaxList.add(
        ...
        CommonDropDownItem("amount", "Montant"),
